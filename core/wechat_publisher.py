...
def main():
    ...
    parser.add_argument("--author", "-a",
                        default=CONFIG.get("wechat", {}).get("author", "") if CONFIG else "",
                        help="作者名")
    ...
    if args.input:
        ...
        if not theme and CONFIG:
            theme = CONFIG.get("settings", {}).get("default_theme", "bold-blue")
        ...
        # 从 format.py 输出中找到目录
        output_base = Path(CONFIG.get("output_dir", "output")) if CONFIG else Path("output")
